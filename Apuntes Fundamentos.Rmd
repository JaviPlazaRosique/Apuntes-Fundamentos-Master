...
class <Nombre de la clase>: 
  ...
  def __init__(self, <atributo 1>, <atributo 2>, <atributo 3>): 
...
Un ejemplo de definición de clase puede ser el siguiente. Donde voy a crear la clase de coches, que tendrá como atributos el color y si es gasolina o diesel. Además tendrá como metodo arrancar y tocar la bocina. 
